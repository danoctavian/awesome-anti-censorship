...
- [palazikVPN](https://github.com/palazik/palazikVPN) - Open-source Android client for Xray/V2Ray. Imports profiles and subscriptions and runs a full-device VPN; supports VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, WireGuard and AnyTLS.
